...
def main():
    ...
    with open(OUT_H, "w") as h:
        ...
        h.write("/* Like mon_icon_for, but the Unown letter `form` (0..27) for species 201. */\n")
        h.write("const uint16_t* mon_icon_for_form(uint16_t species, uint8_t form);\n\n#endif\n")
    ...
    with open(OUT_C, "w") as c:
        ...
        c.write("    return (const uint16_t*)(mon_icon_blob + o);\n")
        c.write("  }\n")
        c.write("  return mon_icon_for(species);\n}\n")
